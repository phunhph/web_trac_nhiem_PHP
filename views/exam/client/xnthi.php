    ...
    <div class="main">
        ...
        <div id="loadajax" style="width:100%; height:auto;">
            <div class="ttdk" style="height:40px;border-bottom: 4px solid blue;">
                <img src="assets/image/danhsach.png" width="23" height="25"
                    style="margin-left:0.5em;margin-top:0.7em; float:left; ">
            ...
            <div class="content" style="z-index:1;width:100%;height:20em;margin-top:0.5em;">
                ...
                <div class="msg"
                    style="background:rgba(153,255,204,0.2); width:98.8%; height:13em; margin-left:0.4em; float:left;">
                    ...
                    <button id="btn"
                        style="margin:auto;display:block;margin-top:4em;background:green;border:none;color:white;font-weight:bold;padding:6px 25px;width:15em; height:2.5em;cursor:pointer;">Bắt
                        đầu làm bài</button>
                </div>
                <?php endif; ?>
            </div>
